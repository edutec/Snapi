...
Process.prototype.extendedProxiedApiCall = function (method, protocol, url, parameters, header) {
    return this.extendedApiCall(method, protocol, this.proxyIP + '/' + url, parameters, header)
}
